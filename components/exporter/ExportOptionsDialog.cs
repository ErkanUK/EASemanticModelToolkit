...
internal sealed record ExportOptions(bool LinkMl, bool JsonSchema, bool Markdown, bool DrawIo, bool PlantUml,
    bool Svg, bool Owl, bool Turtle)
{
    public static ExportOptions All { get; } = new(true, true, true, true, true, true, true, true);
}
...
internal sealed class ExportOptionsDialog : Form
{
    ...
    private readonly CheckBox _plantUml = Box("PlantUML class diagram (.puml)");
    ...
    public ExportOptions Options => new(_linkMl.Checked, _jsonSchema.Checked, _markdown.Checked, _drawIo.Checked,
        _plantUml.Checked, _svg.Checked, _owl.Checked, _turtle.Checked);
    ...
    public ExportOptionsDialog(string packageName)
    {
        ...
        _plantUml.Location = new Point(34, 175);
        ...
        var ok = new Button { Text = "Continue", DialogResult = DialogResult.OK, Location = new Point(416, 266), Size = new Size(80, 28) };
        var cancel = new Button { Text = "Cancel", DialogResult = DialogResult.Cancel, Location = new Point(502, 266), Size = new Size(80, 28) };
        AcceptButton = ok;
        CancelButton = cancel;
        Controls.AddRange([summary, _linkMl, _jsonSchema, _markdown, _plantUml, _drawIo, _svg, _owl, _turtle, ok, cancel]);
    }
